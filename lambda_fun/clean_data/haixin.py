...
def clean_goodsflow(source_id, date, target_table, data_frames):
    ...
    if len(goodsflow1) == 0:
        ...
        goodsflow1 = goodsflow1.merge(lv3_frames, how="left", left_on="item.clsid", right_on="lv3.clsid")
        ...
        goodsflow1 = goodsflow1[(goodsflow1["head.trantype"] != "5") & (goodsflow1["lv3.clscode"].map(len) == 6) &
        ...
        goodsflow1["foreign_category_lv1"] = goodsflow1["foreign_category_lv1"].apply(lambda x: x.zfill(2))
        goodsflow1["foreign_category_lv2"] = goodsflow1["foreign_category_lv2"].apply(lambda x: x.zfill(4))
        goodsflow1["foreign_category_lv3"] = goodsflow1["foreign_category_lv3"].apply(lambda x: x.zfill(6))
    ...
    if len(goodsflow2) == 0:
        ...
        goodsflow2 = goodsflow2.merge(lv2_frames, how="left", left_on="item.clsid", right_on="lv2.clsid")
        ...
        goodsflow2 = goodsflow2[(goodsflow2["head.trantype"] != "5") & (goodsflow2["lv3.clscode"].map(len) == 4) &
        ...
        goodsflow2["foreign_category_lv1"] = goodsflow2["foreign_category_lv1"].apply(lambda x: x.zfill(2))
        goodsflow2["foreign_category_lv2"] = goodsflow2["foreign_category_lv2"].apply(lambda x: x.zfill(4))
...
def clean_cost(source_id, date, target_table, data_frames):
    ...
    if len(cost) == 0:
        ...
        cost1 = cost1.merge(cate_frames, how="left", left_on="foreign_category_lv2", right_on="clscode",
                            suffixes=("", ".lv2"))
        cost1 = cost1[cost1["isactive.lv2"] == "1"]
        cost1 = cost1.merge(cate_frames, how="left", left_on="foreign_category_lv1", right_on="clscode",
                            suffixes=("", ".lv1"))
        cost1 = cost1[cost1["isactive.lv1"] == "1"]
        cost1 = cost1[(cost1["cost.orgcode"] != "00") & (cost1["clscode"].map(len) == 6) & (cost1["islast"] == "1")]
...
def clean_goods(source_id, date, target_table, data_frames):
    ...
    goods1 = goods1.merge(cate_frames, how="left", left_on="foreign_category_lv2", right_on="clscode",
                          suffixes=("", ".lv2"))
    goods1 = goods1[goods1["isactive.lv2"] == "1"]
    goods1 = goods1.merge(cate_frames, how="left", left_on="foreign_category_lv1", right_on="clscode",
                          suffixes=("", ".lv1"))
    ...
    goods2 = goods2.merge(cate_frames, how="left", left_on="foreign_category_lv1", right_on="clscode",
                          suffixes=("", ".lv1"))
...
def clean_category(source_id, date, target_table, data_frames):
    ...
    category1 = lv1_frames[(lv1_frames["lv1.clscode"].map(len) == 2) & (lv1_frames["lv1.isactive"] == "1")]
    ...
    category2 = category2[(category2["lv2.clscode"].map(len) == 4) & (category2["lv2.isactive"] == "1") &
    ...
    category3 = category3[(category3["lv3.clscode"].map(len) == 6) & (category3["lv3.isactive"] == "1") &
                          (category3["lv2.isactive"] == "1") & (category3["lv1.isactive"] == "1")]
